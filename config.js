...
// ║                                                              ║
// ║  Edit this file to customize your Valentine's love letter!   ║
...
// The button also runs away from her cursor! 😄
// Add as many as you want — the more, the funnier!

const NO_BUTTON_TEXTS = [
  'No',
  'Chaka please? 🙏',
  'Pakka Na? 🤨',
  'Bas ab ye baat ho gyi',
  'Soch le ek baar 💭',
  'Manja naa plzzz 🥺',
  "Hayee mera dil 💔",
  "Accha ji chalo maan jao na 😢",
  "Dark chocolate khilaunga 🍫",
  'E meri sitara maan jaa plz ✨',
  'Chaka please? 🙏',
  'Pakka Na? 🤨',
  'Bas ab ye baat ho gyi',
  'Soch le ek baar 💭',
